...
| :--- | :--- | :--- | :--- |
| **Android (AOSP)** | [`android`](https://github.com/JonaNorman/WebViewPackage/releases/tag/android) | `com.google.android.webview` / `com.android.webview` | Official Android open-source system WebView |
